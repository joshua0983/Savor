...
User "1" --|> "1" intellij.ISearch : \tSearches-for\t\t
RestaurantLibrary "1" -|> " 1" Restaurant : \tSearches-for\t\t
intellij.ISearch "1" ---|> " 1" SearchLocation : \tImplements\t\t
intellij.ISearch "1" ---|> " 1" SearchName : \tImplements\t\t
intellij.ISearch "1" ---|> " 1" SearchRating : \tImplements\t\t
'SearchLocation "1" ---|> " 1" RestaurantLibrary : \tFilters\t\t
'SearchRating "1" ---|> " 1" RestaurantLibrary : \tFilters\t\t
intellij.ISearch .. RestaurantLibrary : \tFilters\t\t
